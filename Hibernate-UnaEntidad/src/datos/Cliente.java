...
public class Cliente {
	...
	public Cliente() {} //siempre implementar constructor vacio
	...
	//siempre va protected, no debe ser modificado;
	...
	public String toString() {
		return (idCliente +" " + apellido + " " + nombre + " DNI: " + dni + " F.de Nacimiento:"
				...
				fechaDeNacimiento.getMonthValue() + "/" + fechaDeNacimiento.getYear() +
				" " + baja);
	}
}
