...
public class TestConsultorio {
	...
	public static void main(String[] args) {
		...
		Paciente paciente1 = new Paciente("José","Pérez",1.72f,85);
		Paciente paciente2 = new Paciente("Jorge","Fernández",1.60f,90);
		Paciente paciente3 = new Paciente("Tomás","Zarich",1.73f,72);
		...
		System.out.println("El paciente más alto es: "+medico1.traerPacienteMayorEstatura());
